...
package io.foundy.feature.room.ui.audio

import android.content.Context
import android.media.AudioManager
import io.foundy.feature.room.ui.audio.AudioDevice.BluetoothHeadset
import io.foundy.feature.room.ui.audio.AudioDevice.Earpiece
import io.foundy.feature.room.ui.audio.AudioDevice.Speakerphone
import io.foundy.feature.room.ui.audio.AudioDevice.WiredHeadset
import io.foundy.feature.room.ui.audio.AudioSwitch.State.ACTIVATED
import io.foundy.feature.room.ui.audio.AudioSwitch.State.STARTED
import io.foundy.feature.room.ui.audio.AudioSwitch.State.STOPPED
...
class AudioSwitch internal constructor(
    ...
    private fun getPreferredDeviceList(preferredDeviceList: List<Class<out AudioDevice>>):
        ...
        val shouldUseDefault = preferredDeviceList.isEmpty() ||
            preferredDeviceList == defaultPreferredDeviceList
        return if (shouldUseDefault) {
        ...
        for (audioDevice in preferredDeviceList) {
            ...
            when (audioDevice) {
                ...
                Speakerphone::class.java -> {
                    ...
                    logger.v {
                        "[addAvailableAudioDevices] #Speakerphone; " +
